...
class TryOnProcessor:
    ...
    def postprocess_submasks(
        ...
        arms_wo_hands_init_submask = join_submasks(
            init_submasks, arms_wo_hands_cls
        )

        hands_init_submask = join_submasks(
            init_submasks, hands_cls
        )
    ...
    def get_union_mask(self, init_submasks, result_submasks):
        arms_class_names = self.segmentaion_config['soft_preservation_classes']
    ...
    def process_tryon(
        ...
        positive_prompt = self.config["core_config"]["prompt"].format(**attributes)
        ...
        return inpainting_result_res, result_image_res
