...
class ImageProcessor:
    ...
    def process_image(self, image: Image.Image, model_name: str):
        ...
        input_tensor = self.transform_fn(image).unsqueeze(0).to(Config.DEVICE)
        ...
        class_mapping = {class_name:class_idx  for class_idx,class_name in enumerate(GOLIATH_CLASSES)}
        with open(json_path, 'w') as f:
            json.dump(class_mapping, f)

        return blended_image, npy_path, json_path
...
class GradioInterface:
    ...
    def create_interface(self):
        ...
        def process_image(image, model_name):
            result, npy_path, json_path = self.image_processor.process_image(image, model_name)
            return result, npy_path, json_path
        ...
        with gr.Blocks(js=js_func, theme=gr.themes.Default()) as demo:
            ...
            with gr.Row(elem_classes="content-container"):
                ...
                with gr.Column():
                    ...
                    class_mapping_output = gr.File(label="Mapping (.json)")
            ...
            run_button.click(
                ...
                outputs=[result_image, npy_output, class_mapping_output],
            )
